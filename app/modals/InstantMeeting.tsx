...
const MeetingForm = ({
    ...
    return (
        <>
            ...
            >
                Create Instant MeetHub
            </DialogTitle>

            <Description className='text-xs opacity-40 mb-4'>
                You can start a new MeetHub instantly.
            </Description>
    ...
    return (
        <>
            ...
            <div className='bg-gray-100 p-4 rounded flex items-center justify-between'>
                <p className='text-xs text-gray-500'>{`${process.env.NEXT_PUBLIC_MEETHUB_HOST}/${facetimeLink}`}</p>

                <CopyToClipboard
                    onCopy={handleCopy}
                    text={`${process.env.NEXT_PUBLIC_MEETHUB_HOST}/${facetimeLink}`}
                >
            ...
            <Link href={`${process.env.NEXT_PUBLIC_MEETHUB_HOST}/${facetimeLink}`} className='w-full block bg-green-600 text-white py-3 rounded mt-4'>
                Start MeetHub
            </Link>
        </>
    );
